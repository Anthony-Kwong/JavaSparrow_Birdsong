...
full_data = readRDS("../../../tempo/data/bird_stats.rds")
...
names[2] = "standard deviation gap length"
names[3] = "variance score"
names[5] = "average gap duration"
names[6] = 'average song duration'
...
nointro_data <- readRDS("../../../tempo/data/bird_stats2.rds")
